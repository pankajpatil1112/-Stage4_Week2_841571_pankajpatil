...
public class FavoriteController {
	...
	@HystrixCommand(fallbackMethod = "fallbackgetAllFavoriteMovies", commandProperties = {
			   @HystrixProperty(name = "execution.isolation.thread.timeoutInMilliseconds", value = "1000")
			})
	public ArrayList<Movie> getAllFavoriteMovies(@PathVariable("userId") int userId) throws InterruptedException {
		log.info("START");
	///	Thread.sleep(500);
